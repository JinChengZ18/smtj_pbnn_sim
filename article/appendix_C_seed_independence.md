...
四项结论均对随机数种子稳健：PBNN 的 MNIST 精度、时域展开“$$T{=}4$$ 即逼近渐近精度”的判断、储备池记忆容量及其相对数字 ESN 的能效优势、以及器件标定斜率 $$\beta_s$$，其种子间标准差均远小于各自所依赖的方法间或配置间差异 (见表C.1)；能效优势尤由器件数与运算量决定、本身与种子无关。这表明正文的主线结论并非源于种子的择优选取。
