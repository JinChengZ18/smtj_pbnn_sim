...
Summary of key discoveries from each experiment in the `smtj_pbnn_sim` simulator. All numerical results are from the Chapter 2.3 primary-reference device (Device A, P->AP, t_w = 0.75 ns) unless noted otherwise.
